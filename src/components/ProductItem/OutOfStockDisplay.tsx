...
export const OutOfStockDisplay: FunctionComponent<OutOfStockDisplayProps> = ({ 
  ...
  return (
    <>
      ...
      <div class="pb-4">
        <button class="notify-me flex items-center justify-center text-white text-sm rounded-full h-[32px] w-full p-sm" type="button">{translation.OutOfStockDisplay.notifyMe}</button>      
      </div>
    </>
  );
};
